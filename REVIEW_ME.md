...
- [x] tests/test_owner_jid.py::test_owner_jid_fallback_when_underivable (roadmap:f5b7)
...
- [x] tests/test_keysource.py::test_rejects_non_hex_output (roadmap:w-key) — key
